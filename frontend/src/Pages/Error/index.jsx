...
export function Error() {
  ...
  return (
    <div className="h-screen w-full bg-gray-100 flex justify-center items-center">
      <div className="flex mobile:flex-col text-gray-700 p-10 mobile:p-1">
        <div className="max-w-md">
          <div className="text-5xl font-dark font-bold">404</div>
          <p className="text-2xl text-3xl font-light leading-normal">
          ...
          <button
            onClick={() => navigate("/")}
            className="px-4 bg-indigo-600 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue active:bg-blue-600 hover:bg-blue-700"
          >
            Back to homepage
          </button>
        </div>
